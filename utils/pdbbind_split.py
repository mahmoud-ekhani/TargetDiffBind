...
if __name__ == '__main__':
    ...
    parser.add_argument('--index_path', type=str, default='ml-data/mahmoud/pdbbind/pdbbind_v2020/pocket_10_refined/index.pkl')
    parser.add_argument('--split_mode', type=str, choices=['coreset', 'time'], default='coreset')
    parser.add_argument('--test_path', type=str, default='ml-data/mahmoud/pdbbind/pdbbind_v2020/CASF-2016/coreset')
    parser.add_argument('--val_ratio', type=float, default=0.1)
    parser.add_argument('--val_num', type=int, default=None)
    parser.add_argument('--save_path', type=str, default='ml-data/mahmoud/pdbbind/pdbbind_v2020/pocket_10_refined/split.pt')
